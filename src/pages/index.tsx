...
export default function Home() {
  ...
  return (
    <div className="p-5 md:p-10 bg-gray-50 dark:bg-black">
      <h1 className="flex items-center justify-center text-2xl md:text-3xl font-bold mb-5 center text-center">We ❤️ Arc</h1>
      {error && <div className="text-red-500">Error fetching tweets</div>}
      {tweets.map((tweet: TweetData) => (
        <a className="flex items-center justify-center" key={tweet.id} href={`https://twitter.com/${tweet.userScreenName}/status/${tweet.id}`} target="_blank" rel="noreferrer noopener">
