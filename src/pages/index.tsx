    ...
    <div className="p-5 md:p-10 bg-gray-50 dark:bg-black min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
        {tweets.map((tweet: TweetData) => (
          <a className="relative min-h-128 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-xl border max-w-xl" key={tweet.id} href={`https://twitter.com/${tweet.userScreenName}/status/${tweet.id}`} target="_blank" rel="noreferrer noopener">
            ...
            <p className="text-black dark:text-white block text-lg leading-snug mt-3 mb-24">{tweet.text}</p>
